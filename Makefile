...
SOURCES := core/src/domain.cpp core/src/scheduler.cpp core/src/scheduler_v2.cpp core/src/scheduler_v3.cpp core/src/reviewfault_c.cpp

.PHONY: all test core-test schema-test clean

all: $(TEST_BIN) $(DOMAIN_TEST_BIN) $(V2_TEST_BIN) $(V3_TEST_BIN) $(SHARED_LIB) $(DYNAMIC_ABI_TEST_BIN)
...
core-test: $(TEST_BIN) $(DOMAIN_TEST_BIN) $(V2_TEST_BIN) $(V3_TEST_BIN) $(DYNAMIC_ABI_TEST_BIN)
	./$(TEST_BIN)
	./$(DOMAIN_TEST_BIN)
	./$(V2_TEST_BIN)
	./$(V3_TEST_BIN)
